// Tipi analiz edip ona öre fonksiyonun çağrıldığı yere 
...
var carIcon = L.icon({
  ...
  export function detectIcon(type) {
    switch (type) {
        ...
        case 'job': return companyIcon;
        case 'goto': return vacationIcon;
    };
    };